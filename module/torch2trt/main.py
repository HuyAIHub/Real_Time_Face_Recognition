    ...
    for i, det in enumerate(pred):  # detections per image
        ...
        if len(det):
            ...
            for j in range(det.size()[0]):
                ...
                # print('xywh {}, conf {}, \nlandmarks {}, class_num {}'.format(xyxy, conf, landmarks, class_num))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--img_path', type=str, default="/home/aitraining/Desktop/yolov5-face/worlds-largest-selfie.jpg", help='img path') 
    ...
    # Apply NMS
    pred = non_max_suppression_face(torch.from_numpy(pred), conf_thres=0.1, iou_thres=0.1)
